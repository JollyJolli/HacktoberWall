...
const dates = execFileSync('git', ['log', data.history.revision, '--format=%as'], {cwd:root, encoding:'utf8'}).trim().split('\n');
...
console.log('PASS: evidence, daily Git counts, links, assets, headings, IDs, generated CSS, JS syntax, and 2024 integrity.');
